	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="card bg-muted" style=" margin-top: 28px;">
			    ...
			    <form class="text-left" method = "post" action = "task3_insert.php" style="width: 521px;
                margin-left: 7px;">
			    ...
			    <div class="form-group">
			 	...
			 	<div class="form-group">
			 		...
			 		<input type="radio"  name="E" value="male"> Male
					<input type="radio"  name="E" value= "female" > Female
